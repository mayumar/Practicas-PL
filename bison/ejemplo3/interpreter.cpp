...
/*!
 \mainpage Flex and Bison: example 3
 \author   
 \date     2018 - 4 - 26
 \version  1.0
 \note Novelties
	+ Defined tokens are used: NEWLINE, PLUS, MINUS, ...
    + The unary "+" and "-" are allowed using UNARY precedence.
	+ The lexical errors are shown.
*/
