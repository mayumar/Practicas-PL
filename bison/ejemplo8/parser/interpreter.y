...
stmtlist:  /* empty: epsilon rule */
        ...
        | stmtlist asgn SEMICOLON
            { 
				...
				lp::NumericVariable *n = (lp::NumericVariable *) table.getSymbol($2);

				std::cout << BIYELLOW; 
				std::cout << "Assignment result: ";
				std::cout << RESET; 
				std::cout << n->getValue() << std::endl << std::endl;
            }

		/* MODIFIED in example 8 */ 
...
exp:	NUMBER 
	...
	|	exp POWER exp 
		...
		/* IMPORTANT */
		/* NEW in example 8 and REMOVED in example 9*/
     |	asgn
		{
